...
class Version {
 ...
 private:
  ...
  VersionSet* vset_;  // VersionSet to which this Version belongs属于那一个版本集
...
class VersionSet {
 ...
 private:
  ...
  Version dummy_versions_;  // Version链表的头结点  // Head of circular doubly-linked list of versions.
  Version* current_;        // == dummy_versions_.prev_  // 当前的Version
